...
class AuthorListTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for author_id in range(num_of_authors):
            Author.objects.create(
                first_name=f'Baluria{author_id}',
                last_name=f'surname{author_id}'
            )
    
    def test_view_url_exist_at_desired_location(self):
        response=self.client.get('/locallib/authors/')
    ...
    def test_view_uses_correct_template(self):
        response=self.client.get(reverse('author_list'))
        self.assertEqual(response.status_code,200)
        self.assertTemplateUsed(response,'authorlist.html') 
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/locallib/mybooks/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, 'bookinstance_list_borrowes_user.html')
...
# test cases:
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        self.assertRedirects(response, reverse('borrowed-lib'))
